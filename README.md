...
- [x] Cloudflare Stream 어댑터 — **실계정 검증 완료** (creator 격리 확인)
...
- [x] 하드웨어 한계 실측 — 1080p30 15~18Mbps · 6채널까지 열화 0 (기획서 §6.2)
- [ ] 장시간 실측 (최장 40분 · 72시간 기준 미달)
...
| `npm run clips` | 무결절 검증용 테스트 클립 생성 (가벼움 · 0.3Mbps) |
| `npm run clips:heavy` | 부하 실측용 클립 생성 (15~18Mbps) |
| `npm run bench` | 채널 수를 늘려가며 부하 실측 |
